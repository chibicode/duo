...
Instead of downloading, you can [fork Duo](https://github.com/chibicode/duo/fork) and use the "upstream" strategy described on [this page](https://help.github.com/articles/fork-a-repo) to keep Duo up to date.

## Details

- [`favicon.ico`](/favicon.ico) is generated using [favicon-emoji](https://github.com/albinekb/favicon-emoji).
